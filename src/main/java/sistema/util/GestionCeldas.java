...
public class GestionCeldas extends DefaultTableCellRenderer {
    ...
    private Font normal = new Font("Verdana", Font.PLAIN, 8);
    ...
    private ImageIcon iconoGuardar = new ImageIcon(getClass().getResource(""));
    private ImageIcon iconoBuscar = new ImageIcon(getClass().getResource(""));
...
//
        ...
        if (tipo.equals("especial numerico")) {
        ...
        if (tipo.equals("historial")) {
            ...
            this.setHorizontalAlignment(JLabel.LEFT);
            this.setText((String) value);
            this.setFont(new Font("Verdana", Font.PLAIN, 8));
            this.setToolTipText(this.getText());
            return this;
